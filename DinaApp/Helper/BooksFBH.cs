...
public class BooksFBH
{
    ...
    //connect real time 
    public ObservableCollection<Book> GetAllBooksByYear(int yearId)
    {
        try
        {
        ...
        try
        {
          ...
          .Subscribe(d =>
          {
              ...
              if (d.EventType == Firebase.Database.Streaming.FirebaseEventType.InsertOrUpdate)
              {
                  ...
                  if (d.Object.CategoryId == categoryId && d.Object.IsShow)
                      DatabaseItems.Add(d.Object);
              }
    ...
    public async Task DeleteBook(int id)
    {
        try
        {
          ...
          .OnceAsync<Book>()).Where(a => a.Object.Id == id).FirstOrDefault();
            ...
            await new FinishBooksActionFBH().DeletePrintByBookId(toDeleteBook.Object.Id);
